...
## <a name="implicit-and-explicit-conversions"></a><span data-ttu-id="0ee82-111">Implizite und explizite Konvertierungen</span><span class="sxs-lookup"><span data-stu-id="0ee82-111">Implicit and Explicit Conversions</span></span>
...
## <a name="reference-conversions"></a><span data-ttu-id="0ee82-160">Verweiskonvertierungen</span><span class="sxs-lookup"><span data-stu-id="0ee82-160">Reference Conversions</span></span>
...
## <a name="array-conversions"></a><span data-ttu-id="0ee82-191">Arraykonvertierungen</span><span class="sxs-lookup"><span data-stu-id="0ee82-191">Array Conversions</span></span>
...
<span data-ttu-id="0ee82-210">Ein Array vom Typ A mit einem beliebigen Rang weist auch eine Array Konvertierung in die nicht generischen Auflistungs Schnittstellentypen auf `IList`, `ICollection` und `IEnumerable` in `System.Collections`.</span><span class="sxs-lookup"><span data-stu-id="0ee82-210">Any array of type A with any rank also has an array conversion to the non-generic collection interface types `IList`, `ICollection` and `IEnumerable` found in `System.Collections`.</span></span>
...
<span data-ttu-id="0ee82-242">__Nebenbei.__</span><span class="sxs-lookup"><span data-stu-id="0ee82-242">__Note.__</span></span> <span data-ttu-id="0ee82-243">Das Kopieren der Struktur wird nicht für als `System.ValueType` typisierte geboxte Strukturen durchgeführt, da es nicht möglich ist, die Bindung von `System.ValueType` zu beenden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-243">Structure copying is not done for boxed structures typed as `System.ValueType` because it is not possible to late bind off of `System.ValueType`.</span></span>
...
<span data-ttu-id="0ee82-252">Wie bereits beschrieben, können geschachtelte Werttypen nur in ihren ursprünglichen Typ entpackt werden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-252">As previously described, boxed value types can only be unboxed to their original type.</span></span> <span data-ttu-id="0ee82-253">Eingegebene primitive Typen werden jedoch besonders behandelt, wenn Sie als `Object` eingegeben werden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-253">Boxed primitive types, however, are treated specially when typed as `Object`.</span></span> <span data-ttu-id="0ee82-254">Sie können in beliebige andere primitive Typen konvertiert werden, in die Sie konvertiert werden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-254">They can be converted to any other primitive type that they have a conversion to.</span></span> <span data-ttu-id="0ee82-255">Zum Beispiel:</span><span class="sxs-lookup"><span data-stu-id="0ee82-255">For example:</span></span>
...
* <span data-ttu-id="0ee82-270">Eine Konvertierung der gleichen Klassifizierung (Einschränkung oder Erweiterung) von `T?` in `S?`.</span><span class="sxs-lookup"><span data-stu-id="0ee82-270">A conversion of the same classification (narrowing or widening) from `T?` to `S?`.</span></span>
...
* <span data-ttu-id="0ee82-303">Von `UInteger` bis `ULong`, `Long`, `Decimal`, `Single` oder `Double`.</span><span class="sxs-lookup"><span data-stu-id="0ee82-303">From `UInteger` to `ULong`, `Long`, `Decimal`, `Single`, or `Double`.</span></span>
...
<span data-ttu-id="0ee82-318">__Verweis Konvertierungen__</span><span class="sxs-lookup"><span data-stu-id="0ee82-318">__Reference conversions__</span></span>
...
* <span data-ttu-id="0ee82-348">Von einem Typ `T?` bis zu einem Schnittstellentyp, den der Typ `T` implementiert.</span><span class="sxs-lookup"><span data-stu-id="0ee82-348">From a type `T?` to an interface type that the type `T` implements.</span></span>
...
<span data-ttu-id="0ee82-362">__Boolesche Konvertierungen__</span><span class="sxs-lookup"><span data-stu-id="0ee82-362">__Boolean conversions__</span></span>
...
* <span data-ttu-id="0ee82-377">Von einem numerischen Typ zu einem enumerierten Typ.</span><span class="sxs-lookup"><span data-stu-id="0ee82-377">From a numeric type to an enumerated type.</span></span>
...
<span data-ttu-id="0ee82-385">__Anonyme delegatkonvertierungen__</span><span class="sxs-lookup"><span data-stu-id="0ee82-385">__Anonymous Delegate conversions__</span></span>

* <span data-ttu-id="0ee82-386">Von einem anonymen Delegattyp, der für die Neuklassifizierung einer Lambda-Methode generiert wurde, in einen beliebigen engeren Delegattyp.</span><span class="sxs-lookup"><span data-stu-id="0ee82-386">From an anonymous delegate type generated for a lambda method reclassification to any narrower delegate type.</span></span>

<span data-ttu-id="0ee82-387">__Array Konvertierungen__</span><span class="sxs-lookup"><span data-stu-id="0ee82-387">__Array conversions__</span></span>

* <span data-ttu-id="0ee82-388">Von einem Arraytyp `S` mit einem Elementtyp `Se` in einen Arraytyp `T` mit einem Elementtyp `Te`, vorausgesetzt, dass alle folgenden Punkte zutreffen:</span><span class="sxs-lookup"><span data-stu-id="0ee82-388">From an array type `S` with an element type `Se`, to an array type `T` with an element type `Te`, provided that all of the following are true:</span></span>

  * <span data-ttu-id="0ee82-389">`S` und `T` unterscheiden sich nur im Elementtyp.</span><span class="sxs-lookup"><span data-stu-id="0ee82-389">`S` and `T` differ only in element type.</span></span>
  * <span data-ttu-id="0ee82-390">Sowohl `Se` als auch `Te` sind Verweis Typen oder sind Typparameter, die keine Werttypen sind.</span><span class="sxs-lookup"><span data-stu-id="0ee82-390">Both `Se` and `Te` are reference types or are type parameters not known to be value types.</span></span>
  * <span data-ttu-id="0ee82-391">Eine einschränkende Verweis-, Array-oder Typparameter Konvertierung ist von `Se` bis `Te` vorhanden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-391">A narrowing reference, array, or type parameter conversion exists from `Se` to `Te`.</span></span>

* <span data-ttu-id="0ee82-392">Von einem Arraytyp `S` mit einem Elementtyp `Se` zu einem Arraytyp `T` mit einem enumerierten Elementtyp `Te`, wenn alle folgenden Punkte zutreffen:</span><span class="sxs-lookup"><span data-stu-id="0ee82-392">From an array type `S` with an element type `Se` to an array type `T` with an enumerated element type `Te`, provided all of the following are true:</span></span>

  * <span data-ttu-id="0ee82-393">`S` und `T` unterscheiden sich nur im Elementtyp.</span><span class="sxs-lookup"><span data-stu-id="0ee82-393">`S` and `T` differ only in element type.</span></span>
  * <span data-ttu-id="0ee82-394">`Se` ist der zugrunde liegende Typ von `Te`, oder es handelt sich um unterschiedliche Enumerationstypen, die denselben zugrunde liegenden Typ haben.</span><span class="sxs-lookup"><span data-stu-id="0ee82-394">`Se` is the underlying type of `Te` , or they are both different enumerated types that share the same underlying type.</span></span>

* <span data-ttu-id="0ee82-395">Von einem Arraytyp `S` von Rang 1 mit einem enumerierten Elementtyp `Se` bis `IList(Of Te)`, `IReadOnlyList(Of Te)`, `ICollection(Of Te)`, `IReadOnlyCollection(Of Te)` und `IEnumerable(Of Te)`, wenn eine der folgenden Werte zutrifft:</span><span class="sxs-lookup"><span data-stu-id="0ee82-395">From an array type `S` of rank 1 with an enumerated element type `Se`, to `IList(Of Te)`, `IReadOnlyList(Of Te)`, `ICollection(Of Te)`, `IReadOnlyCollection(Of Te)` and `IEnumerable(Of Te)`, provided one of the following is true:</span></span>

  * <span data-ttu-id="0ee82-396">Sowohl `Se` als auch `Te` sind Verweis Typen, oder sind Typparameter, die als Verweistyp bekannt sind, und eine einschränkende Verweis-, Array-oder Typparameter Konvertierung ist von `Se` in `Te` vorhanden. noch</span><span class="sxs-lookup"><span data-stu-id="0ee82-396">Both `Se` and `Te` are reference types or are type parameters known to be a reference type, and a narrowing reference, array, or type parameter conversion exists from `Se` to `Te`; or</span></span>
  * <span data-ttu-id="0ee82-397">`Se` ist der zugrunde liegende Typ von `Te`, oder es handelt sich um unterschiedliche Enumerationstypen, die denselben zugrunde liegenden Typ haben.</span><span class="sxs-lookup"><span data-stu-id="0ee82-397">`Se` is the underlying type of `Te`, or they are both different enumerated types that share the same underlying type.</span></span>

<span data-ttu-id="0ee82-398">__Werttyp Konvertierungen__</span><span class="sxs-lookup"><span data-stu-id="0ee82-398">__Value type conversions__</span></span>

* <span data-ttu-id="0ee82-399">Von einem Referenztyp zu einem stärker abgeleiteten Werttyp.</span><span class="sxs-lookup"><span data-stu-id="0ee82-399">From a reference type to a more derived value type.</span></span>

* <span data-ttu-id="0ee82-400">Von einem Schnittstellentyp zu einem Werttyp, sofern der Werttyp den Schnittstellentyp implementiert.</span><span class="sxs-lookup"><span data-stu-id="0ee82-400">From an interface type to a value type, provided the value type implements the interface type.</span></span>

<span data-ttu-id="0ee82-401">__Typkonvertierungen, die NULL zulassen__</span><span class="sxs-lookup"><span data-stu-id="0ee82-401">__Nullable Value Type conversions__</span></span>

* <span data-ttu-id="0ee82-402">Von einem Typ `T?` bis zu einem Typ `T`.</span><span class="sxs-lookup"><span data-stu-id="0ee82-402">From a type `T?` to a type `T`.</span></span>

* <span data-ttu-id="0ee82-403">Von einem Typ `T?` bis zu einem Typ `S?`, bei dem eine einschränkende Konvertierung vom Typ `T` in den Typ `S` erfolgt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-403">From a type `T?` to a type `S?`, where there is a narrowing conversion from the type `T` to the type `S`.</span></span>

* <span data-ttu-id="0ee82-404">Von einem Typ `T` bis zu einem Typ `S?`, bei dem eine einschränkende Konvertierung vom Typ `T` in den Typ `S` erfolgt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-404">From a type `T` to a type `S?`, where there is a narrowing conversion from the type `T` to the type `S`.</span></span>

* <span data-ttu-id="0ee82-405">Von einem Typ `S?` bis zu einem Typ `T`, bei dem eine Konvertierung vom Typ `S` in den Typ `T` erfolgt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-405">From a type `S?` to a type `T`, where there is a conversion from the type `S` to the type `T`.</span></span>

<span data-ttu-id="0ee82-406">__Zeichen folgen Konvertierungen__</span><span class="sxs-lookup"><span data-stu-id="0ee82-406">__String conversions__</span></span>

* <span data-ttu-id="0ee82-407">Von `String` bis `Char`.</span><span class="sxs-lookup"><span data-stu-id="0ee82-407">From `String` to `Char`.</span></span>

* <span data-ttu-id="0ee82-408">Von `String` bis `Char()`.</span><span class="sxs-lookup"><span data-stu-id="0ee82-408">From `String` to `Char()`.</span></span>

* <span data-ttu-id="0ee82-409">Von `String` bis `Boolean` und von `Boolean` bis `String`.</span><span class="sxs-lookup"><span data-stu-id="0ee82-409">From `String` to `Boolean` and from `Boolean` to `String`.</span></span>

* <span data-ttu-id="0ee82-410">Konvertierungen zwischen `String` und `Byte`, `SByte`, `UShort`, `Short`, `UInteger`, `Integer`, `ULong`, `Long`, `Decimal`, 0 oder 1.</span><span class="sxs-lookup"><span data-stu-id="0ee82-410">Conversions between `String` and `Byte`, `SByte`, `UShort`, `Short`, `UInteger`, `Integer`, `ULong`, `Long`, `Decimal`, `Single`, or `Double`.</span></span>

* <span data-ttu-id="0ee82-411">Von `String` bis `Date` und von `Date` bis `String`.</span><span class="sxs-lookup"><span data-stu-id="0ee82-411">From `String` to `Date` and from `Date` to `String`.</span></span>

<span data-ttu-id="0ee82-412">__Typparameter Konvertierungen__</span><span class="sxs-lookup"><span data-stu-id="0ee82-412">__Type Parameter conversions__</span></span>

* <span data-ttu-id="0ee82-413">Von `Object` bis zu einem Typparameter.</span><span class="sxs-lookup"><span data-stu-id="0ee82-413">From `Object` to a type parameter.</span></span>

* <span data-ttu-id="0ee82-414">Von einem Typparameter zu einem Schnittstellentyp, wenn der Typparameter nicht auf diese Schnittstelle beschränkt ist oder nicht auf eine Klasse beschränkt ist, die diese Schnittstelle implementiert.</span><span class="sxs-lookup"><span data-stu-id="0ee82-414">From a type parameter to an interface type, provided the type parameter is not constrained to that interface or constrained to a class that implements that interface.</span></span>

* <span data-ttu-id="0ee82-415">Von einem Schnittstellentyp zu einem Typparameter.</span><span class="sxs-lookup"><span data-stu-id="0ee82-415">From an interface type to a type parameter.</span></span>

* <span data-ttu-id="0ee82-416">Von einem Typparameter zu einem abgeleiteten Typ einer Klassen Einschränkung.</span><span class="sxs-lookup"><span data-stu-id="0ee82-416">From a type parameter to a derived type of a class constraint.</span></span>

* <span data-ttu-id="0ee82-417">Von einem Typparameter `T` bis zu einer Typparameter Einschränkung `Tx` eine einschränkende Konvertierung in hat.</span><span class="sxs-lookup"><span data-stu-id="0ee82-417">From a type parameter `T` to anything a type parameter constraint `Tx` has a narrowing conversion to.</span></span>

## <a name="type-parameter-conversions"></a><span data-ttu-id="0ee82-418">Typparameter Konvertierungen</span><span class="sxs-lookup"><span data-stu-id="0ee82-418">Type Parameter Conversions</span></span>

<span data-ttu-id="0ee82-419">Typparameter Konvertierungen werden durch die Einschränkungen festgelegt, die ggf. für Sie festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-419">Type parameters' conversions are determined by the constraints, if any, put on them.</span></span> <span data-ttu-id="0ee82-420">Ein Typparameter `T` kann immer in sich selbst, in und aus `Object` sowie in und aus einem beliebigen Schnittstellentyp konvertiert werden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-420">A type parameter `T` can always be converted to itself, to and from `Object`, and to and from any interface type.</span></span> <span data-ttu-id="0ee82-421">Beachten Sie Folgendes: Wenn der Typ `T` ein Werttyp zur Laufzeit ist, wird die Konvertierung von `T` in `Object` oder einen Schnittstellentyp eine Boxing-Konvertierung, und die Konvertierung von `Object` oder eines Schnittstellen Typs in `T` ist eine Unboxing-Konvertierung.</span><span class="sxs-lookup"><span data-stu-id="0ee82-421">Note that if the type `T` is a value type at run-time, converting from `T` to `Object` or an interface type will be a boxing conversion and converting from `Object` or an interface type to `T` will be an unboxing conversion.</span></span> <span data-ttu-id="0ee82-422">Ein Typparameter mit einer Klassen Einschränkung `C` definiert zusätzliche Konvertierungen vom Typparameter in `C` und seine Basisklassen und umgekehrt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-422">A type parameter with a class constraint `C` defines additional conversions from the type parameter to `C` and its base classes, and vice versa.</span></span> <span data-ttu-id="0ee82-423">Ein Typparameter `T` mit einer Typparameter Einschränkung `Tx` definiert eine Konvertierung in `Tx` und alles, was `Tx` in konvertiert.</span><span class="sxs-lookup"><span data-stu-id="0ee82-423">A type parameter `T` with a type parameter constraint `Tx` defines a conversion to `Tx` and anything `Tx` converts to.</span></span>

<span data-ttu-id="0ee82-424">Ein Array, dessen Elementtyp ein Typparameter mit einer Schnittstellen Einschränkung ist `I` hat die gleichen kovariant-Array Konvertierungen wie ein Array, dessen Elementtyp `I` ist, vorausgesetzt, dass der Typparameter auch eine `Class`-oder eine Klassen Einschränkung hat (da nur auf verwiesen wird). Array Elementtypen können kovariant sein).</span><span class="sxs-lookup"><span data-stu-id="0ee82-424">An array whose element type is a type parameter with an interface constraint `I` has the same covariant array conversions as an array whose element type is `I`, provided that the type parameter also has a `Class` or class constraint (since only reference array element types can be covariant).</span></span> <span data-ttu-id="0ee82-425">Ein Array, dessen Elementtyp ein Typparameter mit einer Klassen Einschränkung ist `C` hat die gleichen kovariant-Array Konvertierungen wie ein Array, dessen Elementtyp `C` ist.</span><span class="sxs-lookup"><span data-stu-id="0ee82-425">An array whose element type is a type parameter with a class constraint `C` has the same covariant array conversions as an array whose element type is `C`.</span></span>

<span data-ttu-id="0ee82-426">Die obigen Konvertierungsregeln erlauben keine Konvertierung von nicht eingeschränkten Typparametern in nicht-Schnittstellentypen, was über rasch sein kann.</span><span class="sxs-lookup"><span data-stu-id="0ee82-426">The above conversions rules do not permit conversions from unconstrained type parameters to non-interface types, which may be surprising.</span></span> <span data-ttu-id="0ee82-427">Der Grund hierfür ist die Vermeidung von Verwirrung bezüglich der Semantik solcher Konvertierungen.</span><span class="sxs-lookup"><span data-stu-id="0ee82-427">The reason for this is to prevent confusion about the semantics of such conversions.</span></span> <span data-ttu-id="0ee82-428">Betrachten Sie beispielsweise die folgende Deklaration:</span><span class="sxs-lookup"><span data-stu-id="0ee82-428">For example, consider the following declaration:</span></span>
...
<span data-ttu-id="0ee82-429">Wenn die Konvertierung von `T` in `Integer` zulässig war, kann man leicht davon ausgehen, dass `X(Of Integer).F(7)` `7L` zurückgeben würde.</span><span class="sxs-lookup"><span data-stu-id="0ee82-429">If the conversion of `T` to `Integer` were permitted, one might easily expect that `X(Of Integer).F(7)` would return `7L`.</span></span> <span data-ttu-id="0ee82-430">Dies würde jedoch nicht der Fall sein, da numerische Konvertierungen nur berücksichtigt werden, wenn die Typen bekanntermaßen zur Kompilierzeit numerisch sind.</span><span class="sxs-lookup"><span data-stu-id="0ee82-430">However, it would not, because numeric conversions are only considered when the types are known to be numeric at compile time.</span></span> <span data-ttu-id="0ee82-431">Damit die Semantik eindeutig ist, muss das obige Beispiel stattdessen geschrieben werden:</span><span class="sxs-lookup"><span data-stu-id="0ee82-431">In order to make the semantics clear, the above example must instead be written:</span></span>
...
## <a name="user-defined-conversions"></a><span data-ttu-id="0ee82-432">Benutzerdefinierte Konvertierungen</span><span class="sxs-lookup"><span data-stu-id="0ee82-432">User-Defined Conversions</span></span>

<span data-ttu-id="0ee82-433">Systeminterne *Konvertierungen* sind Konvertierungen, die von der Sprache definiert werden (d. h. in dieser Spezifikation aufgelistet), während *benutzerdefinierte Konvertierungen* durch Überladen des `CType`-Operators definiert werden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-433">*Intrinsic conversions* are conversions defined by the language (i.e. listed in this specification), while *user-defined conversions* are defined by overloading the `CType` operator.</span></span> <span data-ttu-id="0ee82-434">Wenn bei der Konvertierung zwischen Typen keine systeminternen Konvertierungen anwendbar sind, werden benutzerdefinierte Konvertierungen berücksichtigt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-434">When converting between types, if no intrinsic conversions are applicable then user-defined conversions will be considered.</span></span> <span data-ttu-id="0ee82-435">Wenn eine benutzerdefinierte Konvertierung für die Quell-und Zieltypen *am spezifischsten* ist, wird die benutzerdefinierte Konvertierung verwendet.</span><span class="sxs-lookup"><span data-stu-id="0ee82-435">If there is a user-defined conversion that is *most specific* for the source and target types, then the user-defined conversion will be used.</span></span> <span data-ttu-id="0ee82-436">Andernfalls wird ein Fehler bei der Kompilierzeit ausgegeben.</span><span class="sxs-lookup"><span data-stu-id="0ee82-436">Otherwise, a compile-time error results.</span></span> <span data-ttu-id="0ee82-437">Die spezifischere Konvertierung ist die, deren Operand dem Quelltyp am nächsten ist, und dessen Ergebnistyp dem Zieltyp am nächsten ist.</span><span class="sxs-lookup"><span data-stu-id="0ee82-437">The most specific conversion is the one whose operand is "closest" to the source type and whose result type is "closest" to the target type.</span></span> <span data-ttu-id="0ee82-438">Wenn Sie bestimmen, welche benutzerdefinierte Konvertierung verwendet werden soll, wird die spezifischere erweiternde Konvertierung verwendet. Wenn keine erweiternde Konvertierung am spezifischsten ist, wird die spezifischere einschränkende Konvertierung verwendet.</span><span class="sxs-lookup"><span data-stu-id="0ee82-438">When determining what user-defined conversion to use, the most specific widening conversion will be used; if no widening conversion is most specific, the most specific narrowing conversion will be used.</span></span> <span data-ttu-id="0ee82-439">Wenn keine spezifische einschränkende Konvertierung vorliegt, ist die Konvertierung nicht definiert, und es tritt ein Kompilierzeitfehler auf.</span><span class="sxs-lookup"><span data-stu-id="0ee82-439">If there is no most specific narrowing conversion, then the conversion is undefined and a compile-time error occurs.</span></span>

<span data-ttu-id="0ee82-440">In den folgenden Abschnitten wird erläutert, wie die spezifischsten Konvertierungen bestimmt werden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-440">The following sections cover how the most specific conversions are determined.</span></span> <span data-ttu-id="0ee82-441">Dabei werden die folgenden Begriffe verwendet:</span><span class="sxs-lookup"><span data-stu-id="0ee82-441">They use the following terms:</span></span>

<span data-ttu-id="0ee82-442">Wenn eine systeminterne erweiternde *Konvertierung von einem* Typ `A` in einen Typ `B` erfolgt und weder `A` noch `B` Schnittstellen sind, wird `A` von `B` *und `B` @no__t* -9.</span><span class="sxs-lookup"><span data-stu-id="0ee82-442">If an intrinsic widening conversion exists from a type `A` to a type `B`, and if neither `A` nor `B` are interfaces, then `A` is *encompassed* by `B`, and `B` *encompasses* `A`.</span></span>

<span data-ttu-id="0ee82-443">Der *umfassendste* Typ in einer Reihe von Typen ist der einzige Typ, der alle anderen Typen im Satz umfasst.</span><span class="sxs-lookup"><span data-stu-id="0ee82-443">The *most encompassing* type in a set of types is the one type that encompasses all other types in the set.</span></span> <span data-ttu-id="0ee82-444">Wenn kein einzelner Typ alle anderen Typen umfasst, hat der Satz keinen ganz umfassenden Typ.</span><span class="sxs-lookup"><span data-stu-id="0ee82-444">If no single type encompasses all other types, then the set has no most encompassing type.</span></span> <span data-ttu-id="0ee82-445">Der umfassendste Typ ist in intuitiver Hinsicht der "größte" Typ im Satz. der einzige Typ, auf den jeder der anderen Typen durch eine erweiternde Konvertierung konvertiert werden kann.</span><span class="sxs-lookup"><span data-stu-id="0ee82-445">In intuitive terms, the most encompassing type is the "largest" type in the set -- the one type to which each of the other types can be converted through a widening conversion.</span></span>

<span data-ttu-id="0ee82-446">Der *am häufigsten* in einem Satz von Typen eingeschlossenen Typ ist ein Typ, der von allen anderen Typen im Satz eingeschlossen wird.</span><span class="sxs-lookup"><span data-stu-id="0ee82-446">The *most encompassed* type in a set of types is the one type that is encompassed by all other types in the set.</span></span> <span data-ttu-id="0ee82-447">Wenn kein einzelner Typ von allen anderen Typen eingeschlossen wird, hat der Satz nicht den meisten Typ.</span><span class="sxs-lookup"><span data-stu-id="0ee82-447">If no single type is encompassed by all other types, then the set has no most encompassed type.</span></span> <span data-ttu-id="0ee82-448">Der umfassendste Typ ist in intuitiver Hinsicht der "kleinste" Typ im Satz. der einzige Typ, der durch eine einschränkende Konvertierung in jeden der anderen Typen konvertiert werden kann.</span><span class="sxs-lookup"><span data-stu-id="0ee82-448">In intuitive terms, the most encompassed type is the "smallest" type in the set -- the one type that can be converted to each of the other types through a narrowing conversion.</span></span>

<span data-ttu-id="0ee82-449">Beim Erfassen der benutzerdefinierten benutzerdefinierten Konvertierungen für einen Typ `T?` werden stattdessen die von `T` definierten benutzerdefinierten Konvertierungs Operatoren verwendet.</span><span class="sxs-lookup"><span data-stu-id="0ee82-449">When collecting the candidate user-defined conversions for a type `T?`, the user-defined conversion operators defined by `T` are used instead.</span></span> <span data-ttu-id="0ee82-450">Wenn der Typ, in den konvertiert wird, auch ein Werttyp ist, der NULL-Werte zulässt, werden alle benutzerdefinierten Konvertierungs Operatoren von `T`, die nur nicht auf NULL festleg Bare Werttypen einschließen, angehoben.</span><span class="sxs-lookup"><span data-stu-id="0ee82-450">If the type being converted to is also a nullable value type, then any of `T`'s user-defined conversions operators that involve only non-nullable value types are lifted.</span></span> <span data-ttu-id="0ee82-451">Ein Konvertierungs Operator von `T` bis `S` wird als Konvertierung von `T?` in `S?` angehoben und ausgewertet, indem `T?` in `T` konvertiert wird. Anschließend wird der benutzerdefinierte Konvertierungs Operator von `T` zu `S` ausgewertet. bei Bedarf wird `S` in `S?` umgerechnet.</span><span class="sxs-lookup"><span data-stu-id="0ee82-451">A conversion operator from `T` to `S` is lifted to be a conversion from `T?` to `S?` and is evaluated by converting `T?` to `T`, if necessary, then evaluating the user-defined conversion operator from `T` to `S` and then converting `S` to `S?`, if necessary.</span></span> <span data-ttu-id="0ee82-452">Wenn der konvertierte Wert `Nothing` ist, wird ein Operator mit erhöhten Konvertierungen direkt in den `Nothing`-Wert konvertiert, der als `S?` typisiert ist.</span><span class="sxs-lookup"><span data-stu-id="0ee82-452">If the value being converted is `Nothing`, however, a lifted conversion operator converts directly into a value of `Nothing` typed as `S?`.</span></span> <span data-ttu-id="0ee82-453">Zum Beispiel:</span><span class="sxs-lookup"><span data-stu-id="0ee82-453">For example:</span></span>
...
<span data-ttu-id="0ee82-454">Beim Auflösen von Konvertierungen werden benutzerdefinierte Konvertierungs Operatoren immer für gesteigerte Konvertierungs Operatoren bevorzugt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-454">When resolving conversions, user-defined conversions operators are always preferred over lifted conversion operators.</span></span> <span data-ttu-id="0ee82-455">Zum Beispiel:</span><span class="sxs-lookup"><span data-stu-id="0ee82-455">For example:</span></span>
...
<span data-ttu-id="0ee82-456">Zur Laufzeit kann das Auswerten einer benutzerdefinierten Konvertierung bis zu drei Schritte umfassen:</span><span class="sxs-lookup"><span data-stu-id="0ee82-456">At run-time, evaluating a user-defined conversion can involve up to three steps:</span></span>

1. <span data-ttu-id="0ee82-457">Zuerst wird der Wert mithilfe einer systeminternen Konvertierung aus dem Quelltyp in den Operanden konvertiert.</span><span class="sxs-lookup"><span data-stu-id="0ee82-457">First, the value is converted from the source type to the operand type using an intrinsic conversion, if necessary.</span></span>

2. <span data-ttu-id="0ee82-458">Anschließend wird die benutzerdefinierte Konvertierung aufgerufen.</span><span class="sxs-lookup"><span data-stu-id="0ee82-458">Then, the user-defined conversion is invoked.</span></span>

3. <span data-ttu-id="0ee82-459">Schließlich wird das Ergebnis der benutzerdefinierten Konvertierung mithilfe einer systeminternen Konvertierung in den Zieltyp konvertiert, falls erforderlich.</span><span class="sxs-lookup"><span data-stu-id="0ee82-459">Finally, the result of the user-defined conversion is converted to the target type using an intrinsic conversion, if necessary.</span></span>

<span data-ttu-id="0ee82-460">Beachten Sie unbedingt, dass die Auswertung einer benutzerdefinierten Konvertierung nie mehr als einen benutzerdefinierten Konvertierungs Operator einschließt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-460">It is important to note that evaluation of a user-defined conversion will never involve more than one user-defined conversion operator.</span></span>

### <a name="most-specific-widening-conversion"></a><span data-ttu-id="0ee82-461">Spezifischere erweiternde Konvertierung</span><span class="sxs-lookup"><span data-stu-id="0ee82-461">Most Specific Widening Conversion</span></span>

<span data-ttu-id="0ee82-462">Die Ermittlung des spezifischsten benutzerdefinierten erweiterungskonvertierungsoperators zwischen zwei Typen erfolgt mithilfe der folgenden Schritte:</span><span class="sxs-lookup"><span data-stu-id="0ee82-462">Determining the most specific user-defined widening conversion operator between two types is accomplished using the following steps:</span></span>

1. <span data-ttu-id="0ee82-463">Zuerst werden alle Kandidaten Konvertierungs Operatoren gesammelt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-463">First, all of the candidate conversion operators are collected.</span></span> <span data-ttu-id="0ee82-464">Die Operatoren für die Kandidaten Konvertierung sind alle benutzerdefinierten Erweiterungs Operatoren im Quelltyp und alle benutzerdefinierten Erweiterungs Operatoren im Zieltyp.</span><span class="sxs-lookup"><span data-stu-id="0ee82-464">The candidate conversion operators are all of the user-defined widening conversion operators in the source type and all of the user-defined widening conversion operators in the target type.</span></span>

2. <span data-ttu-id="0ee82-465">Anschließend werden alle nicht anwendbaren Konvertierungs Operatoren aus dem Satz entfernt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-465">Then, all non-applicable conversion operators are removed from the set.</span></span> <span data-ttu-id="0ee82-466">Ein Konvertierungs Operator ist auf einen Quelltyp und einen Zieltyp anwendbar, wenn es einen intrinsischen erweiterbaren Konvertierungs Operator vom Quelltyp zum Operanden-Typ gibt und es einen intrinsischen erweiterbaren Konvertierungs Operator vom Ergebnis des Operators zum Zieltyp gibt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-466">A conversion operator is applicable to a source type and target type if there is an intrinsic widening conversion operator from the source type to the operand type and there is an intrinsic widening conversion operator from the result of the operator to the target type.</span></span> <span data-ttu-id="0ee82-467">Wenn keine anwendbaren Konvertierungs Operatoren vorhanden sind, gibt es keine spezifischere erweiternde Konvertierung.</span><span class="sxs-lookup"><span data-stu-id="0ee82-467">If there are no applicable conversion operators, then there is no most specific widening conversion.</span></span>

3. <span data-ttu-id="0ee82-468">Anschließend wird der spezifischere Quelltyp der anwendbaren Konvertierungs Operatoren bestimmt:</span><span class="sxs-lookup"><span data-stu-id="0ee82-468">Then, the most specific source type of the applicable conversion operators is determined:</span></span>

   * <span data-ttu-id="0ee82-469">Wenn ein Konvertierungs Operator direkt aus dem Quelltyp konvertiert wird, ist der Quelltyp der spezifischere Quelltyp.</span><span class="sxs-lookup"><span data-stu-id="0ee82-469">If any of the conversion operators convert directly from the source type, then the source type is the most specific source type.</span></span>

   * <span data-ttu-id="0ee82-470">Andernfalls ist der spezifischere Quelltyp der am häufigsten in der kombinierten Gruppe von Quell Typen der Konvertierungs Operatoren eingeschlossenen Typ.</span><span class="sxs-lookup"><span data-stu-id="0ee82-470">Otherwise, the most specific source type is the most encompassed type in the combined set of source types of the conversion operators.</span></span> <span data-ttu-id="0ee82-471">Wenn kein Typ gefunden werden kann, der sich in der angegebenen Erweiterung befindet, gibt es keine spezifischere Erweiterungs Konvertierung.</span><span class="sxs-lookup"><span data-stu-id="0ee82-471">If no most encompassed type can be found, then there is no most specific widening conversion.</span></span>

4. <span data-ttu-id="0ee82-472">Anschließend wird der spezifischere Zieltyp der anwendbaren Konvertierungs Operatoren bestimmt:</span><span class="sxs-lookup"><span data-stu-id="0ee82-472">Then, the most specific target type of the applicable conversion operators is determined:</span></span>

   * <span data-ttu-id="0ee82-473">Wenn ein Konvertierungs Operator direkt in den Zieltyp konvertiert wird, ist der Zieltyp der spezifischere Zieltyp.</span><span class="sxs-lookup"><span data-stu-id="0ee82-473">If any of the conversion operators convert directly to the target type, then the target type is the most specific target type.</span></span>

   * <span data-ttu-id="0ee82-474">Andernfalls ist der spezifischere Zieltyp der umfassendste Typ in der kombinierten Gruppe von Zieltypen der Konvertierungs Operatoren.</span><span class="sxs-lookup"><span data-stu-id="0ee82-474">Otherwise, the most specific target type is the most encompassing type in the combined set of target types of the conversion operators.</span></span> <span data-ttu-id="0ee82-475">Wenn kein umfassender Typ gefunden werden kann, gibt es keine spezifischere erweiternde Konvertierung.</span><span class="sxs-lookup"><span data-stu-id="0ee82-475">If no most encompassing type can be found, then there is no most specific widening conversion.</span></span>

5. <span data-ttu-id="0ee82-476">Wenn dann genau ein Konvertierungs Operator vom spezifischsten Quelltyp in den spezifischsten Zieltyp konvertiert wird, ist dies der spezifischere Konvertierungs Operator.</span><span class="sxs-lookup"><span data-stu-id="0ee82-476">Then, if exactly one conversion operator converts from the most specific source type to the most specific target type, then this is the most specific conversion operator.</span></span> <span data-ttu-id="0ee82-477">Wenn mehr als ein solcher Operator vorhanden ist, gibt es keine spezifischere erweiternde Konvertierung.</span><span class="sxs-lookup"><span data-stu-id="0ee82-477">If more than one such operator exists, then there is no most specific widening conversion.</span></span>

### <a name="most-specific-narrowing-conversion"></a><span data-ttu-id="0ee82-478">Die spezifischere einschränkende Konvertierung</span><span class="sxs-lookup"><span data-stu-id="0ee82-478">Most Specific Narrowing Conversion</span></span>

<span data-ttu-id="0ee82-479">Die Ermittlung des spezifischsten benutzerdefinierten einschränkenden Konvertierungs Operators zwischen zwei Typen erfolgt mithilfe der folgenden Schritte:</span><span class="sxs-lookup"><span data-stu-id="0ee82-479">Determining the most specific user-defined narrowing conversion operator between two types is accomplished using the following steps:</span></span>

1. <span data-ttu-id="0ee82-480">Zuerst werden alle Kandidaten Konvertierungs Operatoren gesammelt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-480">First, all of the candidate conversion operators are collected.</span></span> <span data-ttu-id="0ee82-481">Die Operatoren für die Kandidaten Konvertierung sind alle benutzerdefinierten Konvertierungs Operatoren im Quelltyp und alle benutzerdefinierten Konvertierungs Operatoren im Zieltyp.</span><span class="sxs-lookup"><span data-stu-id="0ee82-481">The candidate conversion operators are all of the user-defined conversion operators in the source type and all of the user-defined conversion operators in the target type.</span></span>

2. <span data-ttu-id="0ee82-482">Anschließend werden alle nicht anwendbaren Konvertierungs Operatoren aus dem Satz entfernt.</span><span class="sxs-lookup"><span data-stu-id="0ee82-482">Then, all non-applicable conversion operators are removed from the set.</span></span> <span data-ttu-id="0ee82-483">Ein Konvertierungs Operator ist auf einen Quelltyp und einen Zieltyp anwendbar, wenn ein System interner Konvertierungs Operator vom Quelltyp zum Operanden-Typ vorhanden ist und ein System interner Konvertierungs Operator vom Ergebnis des Operators zum Zieltyp vorhanden ist.</span><span class="sxs-lookup"><span data-stu-id="0ee82-483">A conversion operator is applicable to a source type and target type if there is an intrinsic conversion operator from the source type to the operand type and there is an intrinsic conversion operator from the result of the operator to the target type.</span></span> <span data-ttu-id="0ee82-484">Wenn keine anwendbaren Konvertierungs Operatoren vorhanden sind, gibt es keine spezifischere einschränkende Konvertierung.</span><span class="sxs-lookup"><span data-stu-id="0ee82-484">If there are no applicable conversion operators, then there is no most specific narrowing conversion.</span></span>

3. <span data-ttu-id="0ee82-485">Anschließend wird der spezifischere Quelltyp der anwendbaren Konvertierungs Operatoren bestimmt:</span><span class="sxs-lookup"><span data-stu-id="0ee82-485">Then, the most specific source type of the applicable conversion operators is determined:</span></span>

   * <span data-ttu-id="0ee82-486">Wenn ein Konvertierungs Operator direkt aus dem Quelltyp konvertiert wird, ist der Quelltyp der spezifischere Quelltyp.</span><span class="sxs-lookup"><span data-stu-id="0ee82-486">If any of the conversion operators convert directly from the source type, then the source type is the most specific source type.</span></span>

   * <span data-ttu-id="0ee82-487">Andernfalls handelt es sich beim Konvertieren eines Konvertierungs Operators aus Typen, die den Quelltyp einschließen, um den am meisten spezifisierten Typ in der kombinierten Gruppe von Quell Typen dieser Konvertierungs Operatoren.</span><span class="sxs-lookup"><span data-stu-id="0ee82-487">Otherwise, if any of the conversion operators convert from types that encompass the source type, then the most specific source type is the most encompassed type in the combined set of source types of those conversion operators.</span></span> <span data-ttu-id="0ee82-488">Wenn kein Typ gefunden werden kann, der sich in der gleichen Form befindet, ist keine besonders einschränkende Konvertierung vorhanden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-488">If no most encompassed type can be found, then there is no most specific narrowing conversion.</span></span>

   * <span data-ttu-id="0ee82-489">Andernfalls ist der spezifischere Quelltyp der umfassendste Typ in der kombinierten Gruppe von Quell Typen der Konvertierungs Operatoren.</span><span class="sxs-lookup"><span data-stu-id="0ee82-489">Otherwise, the most specific source type is the most encompassing type in the combined set of source types of the conversion operators.</span></span> <span data-ttu-id="0ee82-490">Wenn kein umfassender Typ gefunden werden kann, gibt es keine spezifischere einschränkende Konvertierung.</span><span class="sxs-lookup"><span data-stu-id="0ee82-490">If no most encompassing type can be found, then there is no most specific narrowing conversion.</span></span>

4. <span data-ttu-id="0ee82-491">Anschließend wird der spezifischere Zieltyp der anwendbaren Konvertierungs Operatoren bestimmt:</span><span class="sxs-lookup"><span data-stu-id="0ee82-491">Then, the most specific target type of the applicable conversion operators is determined:</span></span>

   * <span data-ttu-id="0ee82-492">Wenn ein Konvertierungs Operator direkt in den Zieltyp konvertiert wird, ist der Zieltyp der spezifischere Zieltyp.</span><span class="sxs-lookup"><span data-stu-id="0ee82-492">If any of the conversion operators convert directly to the target type, then the target type is the most specific target type.</span></span>

   * <span data-ttu-id="0ee82-493">Wenn ein Konvertierungs Operator in Typen konvertiert wird, die durch den Zieltyp eingeschlossen werden, dann ist der spezifischere Zieltyp der umfassendste Typ in der kombinierten Gruppe von Quell Typen dieser Konvertierungs Operatoren.</span><span class="sxs-lookup"><span data-stu-id="0ee82-493">Otherwise, if any of the conversion operators convert to types that are encompassed by the target type, then the most specific target type is the most encompassing type in the combined set of source types of those conversion operators.</span></span> <span data-ttu-id="0ee82-494">Wenn kein umfassender Typ gefunden werden kann, gibt es keine spezifischere einschränkende Konvertierung.</span><span class="sxs-lookup"><span data-stu-id="0ee82-494">If no most encompassing type can be found, then there is no most specific narrowing conversion.</span></span>

   * <span data-ttu-id="0ee82-495">Andernfalls ist der spezifischere Zieltyp der Typ, der in der kombinierten Gruppe von Zieltypen der Konvertierungs Operatoren am häufigsten enthalten ist.</span><span class="sxs-lookup"><span data-stu-id="0ee82-495">Otherwise, the most specific target type is the most encompassed type in the combined set of target types of the conversion operators.</span></span> <span data-ttu-id="0ee82-496">Wenn kein Typ gefunden werden kann, der sich in der gleichen Form befindet, ist keine besonders einschränkende Konvertierung vorhanden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-496">If no most encompassed type can be found, then there is no most specific narrowing conversion.</span></span>

5. <span data-ttu-id="0ee82-497">Wenn dann genau ein Konvertierungs Operator vom spezifischsten Quelltyp in den spezifischsten Zieltyp konvertiert wird, ist dies der spezifischere Konvertierungs Operator.</span><span class="sxs-lookup"><span data-stu-id="0ee82-497">Then, if exactly one conversion operator converts from the most specific source type to the most specific target type, then this is the most specific conversion operator.</span></span> <span data-ttu-id="0ee82-498">Wenn mehr als ein solcher Operator vorhanden ist, gibt es keine spezifischere einschränkende Konvertierung.</span><span class="sxs-lookup"><span data-stu-id="0ee82-498">If more than one such operator exists, then there is no most specific narrowing conversion.</span></span>

## <a name="native-conversions"></a><span data-ttu-id="0ee82-499">Native Konvertierungen</span><span class="sxs-lookup"><span data-stu-id="0ee82-499">Native Conversions</span></span>

<span data-ttu-id="0ee82-500">Einige der Konvertierungen werden als systemeigene *Konvertierungen* klassifiziert, da Sie von der .NET Framework nativ unterstützt werden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-500">Several of the conversions are classified as *native conversions* because they are supported natively by the .NET Framework.</span></span> <span data-ttu-id="0ee82-501">Diese Konvertierungen können mithilfe der Konvertierungs Operatoren `DirectCast` und `TryCast` sowie anderer spezieller Verhaltensweisen optimiert werden.</span><span class="sxs-lookup"><span data-stu-id="0ee82-501">These conversions are ones that can be optimized through the use of the `DirectCast` and `TryCast` conversion operators, as well as other special behaviors.</span></span> <span data-ttu-id="0ee82-502">Die als Native Konvertierungen klassifizierten Konvertierungen sind: Identitäts Konvertierungen, Standard Konvertierungen, Verweis Konvertierungen, Array Konvertierungen, Werttyp Konvertierungen und Typparameter Konvertierungen.</span><span class="sxs-lookup"><span data-stu-id="0ee82-502">The conversions classified as native conversions are: identity conversions, default conversions, reference conversions, array conversions, value type conversions, and type parameter conversions.</span></span>

## <a name="dominant-type"></a><span data-ttu-id="0ee82-503">Dominanter Typ</span><span class="sxs-lookup"><span data-stu-id="0ee82-503">Dominant Type</span></span>

<span data-ttu-id="0ee82-504">Wenn ein Satz von Typen vorliegt, ist es häufig erforderlich, dass in Situationen wie z. b. der Typrückschluss der bestimmende *Typ* der Menge bestimmt wird.</span><span class="sxs-lookup"><span data-stu-id="0ee82-504">Given a set of types, it is often necessary in situations such as type inference to determine the *dominant type* of the set.</span></span> <span data-ttu-id="0ee82-505">Der vorherrschende Typ eines Satzes von Typen wird bestimmt, indem zuerst alle Typen entfernt werden, für die ein oder mehrere andere Typen keine implizite Konvertierung in aufweisen.</span><span class="sxs-lookup"><span data-stu-id="0ee82-505">The dominant type of a set of types is determined by first removing any types that one or more other types do not have an implicit conversion to.</span></span> <span data-ttu-id="0ee82-506">Wenn an dieser Stelle keine Typen übrig sind, gibt es keinen vorherrschenden Typ.</span><span class="sxs-lookup"><span data-stu-id="0ee82-506">If there are no types left at this point, there is no dominant type.</span></span> <span data-ttu-id="0ee82-507">Der bestimmende Typ ist dann die meisten der verbleibenden Typen.</span><span class="sxs-lookup"><span data-stu-id="0ee82-507">The dominant type is then the most encompassed of the remaining types.</span></span> <span data-ttu-id="0ee82-508">Wenn mehr als ein Typ vorhanden ist, der am meisten eingeschlossen ist, gibt es keinen vorherrschenden Typ.</span><span class="sxs-lookup"><span data-stu-id="0ee82-508">If there is more than one type that is most encompassed, then there is no dominant type.</span></span>
